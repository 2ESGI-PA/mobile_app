...
class AvailableServicesActivity : AppCompatActivity() {
    ...
    private fun showCustomBookingDialog(item: ServiceSummaryDto, selectedTimestamp: Long) {
        ...
        val tvItemTitle = dialogView.findViewById<TextView>(R.id.text_view_dialog_item_title)
        val tvItemDateTime = dialogView.findViewById<TextView>(R.id.text_view_dialog_item_date_time)
        val etNotes = dialogView.findViewById<EditText>(R.id.edit_text_booking_notes)
        val btnSave = dialogView.findViewById<Button>(R.id.button_save_notes)
        val btnCancel = dialogView.findViewById<Button>(R.id.button_cancel_notes)
        ...
        val dateString = AndroidDateFormat.getLongDateFormat(this).format(dateTimeCalendar.time)
        val timeString = AndroidDateFormat.getTimeFormat(this).format(dateTimeCalendar.time)
